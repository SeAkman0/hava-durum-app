...
class TurkeyCitiesData {
  static final Map<String, List<String>> citiesAndDistricts = {
    'İstanbul': [
    ...
    'Aksaray': [
      'Ağaçören', 'Eskil', 'Gülağaç', 'Güzelyurt', 'Merkez', 'Ortaköy', 'Sarıyahşi', 'Sultanhani'
    ],
    'Amasya': [
    ...
    'Giresun': [
      ...
      'Eynesil', 'Görele', 'Güce', 'Keşap', 'Merkez', 'Piraziz', 'Şebinkarahisar', 'Tirebolu', 'Yağlıdere'
    ],
    'Gümüşhane': [
    ...
    'Samsun': [
      ...
      'Tekkeköy', 'Terms', 'Vezirköprü', 'Yakakent'
    ],
    'Şanlıurfa': [
    ...
    'Yozgat': [
      ...
      'Kadışehri', 'Merkez', 'Saraykent', 'Sarıkaya', 'Sorgun', 'Şefaatli', 'Yerköy', 'Yenifakılı'
    ],
    'Zonguldak': [
  ...
  static List<String> get cities => citiesAndDistricts.keys.toList()..sort();
